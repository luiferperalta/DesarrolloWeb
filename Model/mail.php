...
class Mail extends DATABASE{
    ...
    public function activarUserMail($user)
    {
        ...
        try {
            ...
            $mail->Body  .= '<br> <a href="http://localhost/WEB%20NEW/ruteador.php?controller=Mail&action=activarUser&key=' . $usuario->getByUser($user)->PASSWORD . '>Enlace de Verificacion</a>  ';
    ...
    public function recuperacionPassMail($cod,$user) {
        ...
        try {
            ...
            $mail->Body   = '<b> Ciodigo de Recuperacion </b>';
